        ...
        <div class="max-w-[1200px] mx-auto pb-4 pt-12 sm:pt-16 md:pt-18">
          <div class="flex flex-col md:flex-row md:space-x-4">
            ...
            <div class="md:w-[30%] p-4">
              ...
              <p class="text-sm sm:text-base md:text-[16px] text-[#291570]">Email: <span className="font-semibold">maaz@meemfordesign.com</span></p>
              <p class="text-sm sm:text-base md:text-[16px] text-[#291570] mb-4">Phone: <span className="font-semibold">+923102749082</span></p>
